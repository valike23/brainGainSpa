    ...
    <ul class="mobile-menu-wrapper border-top border-theme-29 dark-border-dark-3 py-5">
        ...
        <li>
            <a href="javascript:;" class="menu">
                <div class="menu__icon">    <svg
                    ...
                    ></svg
                ></div>
                <div class="menu__title"> Educational Games</div>
            </a>
        </li>
        ...
        <li>
            <a href="javascript:;" class="menu">
                ...
                <div class="menu__title"> Academics <i data-feather="chevron-down" class="menu__sub-icon "></i> </div>
            </a>
            <ul class="">
                <li>
        ...
        <li>
            ...
            <ul class="">
                <li>
                    <a rel="external" href="accounts/referrals" class="menu">
                        <div class="menu__icon"> <i data-feather="activity"></i> </div>
